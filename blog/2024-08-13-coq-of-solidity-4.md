...
```
We specify it in the file [erc20.v](https://github.com/formal-land/rocq-of-solidity/blob/guillaume-claret%40verify-erc20/CoqOfSolidity/simulations/erc20.v) by:
```coq
